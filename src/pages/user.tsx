...
import { ChakraProvider, Box, VStack, Heading, Text, Button, Image, HStack, Badge } from '@chakra-ui/react';
      ...
      <Box maxWidth="400px" margin="auto" p={4}>
        ...
        <VStack align="stretch" spacing={4}>
          ...
          <Box bg="gray.50" p={4} borderRadius="md">
            <Heading size="sm" mb={2}>盲盒活动说明</Heading>
          ...
          <Box bg="gray.50" p={4} borderRadius="md">
            <Heading size="sm" mb={2}>当前NFT</Heading>
            <VStack align="stretch" spacing={1}>
